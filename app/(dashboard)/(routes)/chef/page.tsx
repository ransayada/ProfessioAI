...
const ChefPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post("/api/chef", {
        messages: newMessage,
      });
  ...
  return (
    <>
      <div>
        <Heading
          title="Michelin Restaurant Chef"
          description="Describe the Course or the Dish and our AI Michelin Restaurant Chef will help you describe and make it."
          icon={Utensils}
