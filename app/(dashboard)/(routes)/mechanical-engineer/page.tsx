...
const MechanicalEngineerPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post("/api/mechanical-engineer", {
        messages: newMessage,
      });
    ...
    <>
      <div>
        <Heading
          ...
          description="Describe the Mechanical or Technological problem and our AI Mechanical Engineer will help you explain and solve it."
          icon={Cog}
