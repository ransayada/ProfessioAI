...
const GraphicDesignPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post("/api/graphic-design", {
        messages: newMessage,
      });
    ...
    <>
      <div>
        <Heading
          ...
          description="Describe the Graphics and our AI Graphic Designer will help you explain it to dall-e mid journy and other ai image generating tools."
          icon={Ratio}
