...
const AccountantPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post("/api/accountant", {
        messages: newMessage,
      });
    ...
    <>
      <div>
        <Heading
          ...
          description="Describe the Accounting or tax problem and our AI Financial Accountant will help you explain and solve it."
          icon={Calculator}
